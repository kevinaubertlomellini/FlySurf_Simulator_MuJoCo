...
alpha_H = 0.4*np.array([45,45,120])
alpha_G = 0
alpha_Rs = 0.5*np.array([1000,1000,1400])
Q_0 = 190000 * np.eye(6)
Q_0[0:2, 0:2] = 80000 * np.eye(2)
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    output = cv2.VideoWriter("SMPC_Mujoco_9UAV_Space.avi", cv2.VideoWriter_fourcc(*'MPEG'), 1 / T_s,
