...
for ii in range(iter+N_horizon+1):
    ...
    if ii<=iter:
        if 5 > ii * delta_factor * T_s:
            ...
            print(c_0)
        if (8.0 < ii * delta_factor * model.opt.timestep) and (15 >= ii * delta_factor * T_s):
...
spring_factor = 25
# CONTROL PARAMETERS
Q_vector = [1100, 700, 0, 0, 150, 70, 10, 10] # [x and y, z, v_x and v_y, v_z, x_UAV and y_UAV, z_UAV , v_x_quad and v_y_quad, v_z_quad]
