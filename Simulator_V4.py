...
e_save2 = np.zeros((iter,1))# SHAPE PLANNER ADDED
...
flysurf = CatenaryFlySurf(n_points2, n_points, l0+0.0011, num_sample_per_curve=n_points2+1)
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running() and data.time <= total_time:
        ...
        xe = sampling_v1(fig, ax, flysurf, n_points2 - 1, points, plot=False)
