...
# CONTROL PARAMETERS
Q_vector = [200 , 100, 0, 0, 10, 10, 0, 0] # [x and y, z, v_x and v_y, v_z, x_UAV and y_UAV, z_UAV , v_x_quad and v_y_quad, v_z_quad]
R_vector = 20*np.array([3.4, 1.65]) # [force in x and y, force in z]
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    output = cv2.VideoWriter("MPC_Mujoco_25UAV_Space.avi", cv2.VideoWriter_fourcc(*'MPEG'), 1/T_s, (view_width, view_height))
