...
# CONTROL PARAMETERS
Q_vector = [8500, 3500, 0, 0, 8500, 3500, 10, 10] # [x and y, z, v_x and v_y, v_z, x_UAV and y_UAV, z_UAV , v_x_quad and v_y_quad, v_z_quad]
...
R_vector = [0.5, 0.5] # [force in x and y, force in z]
...
plot_errors3(t_save[0:step-1], step-1, x_save[:,0:step-1], xd_save[:,0:step-1], x_gamma_save[:,0:step-1], n_tasks)
