...
quad_positions = [[x, y] for x, y in itertools.product(range(1, rows+1, 2), repeat=2)]
...
shape_semi_cylinder = shape_semi_cylinder_arc(sides=0.9, amplitude=0.55, center=[0.0, 0.0], radius=0.35, n_points=[rows, cols])
