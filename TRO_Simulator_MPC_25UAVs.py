...
# CONTROL PARAMETERS
Q_vector = [200 , 100, 0, 0, 5, 5, 0, 0] # [x and y, z, v_x and v_y, v_z, x_UAV and y_UAV, z_UAV , v_x_quad and v_y_quad, v_z_quad]
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    output = cv2.VideoWriter("MPC_Mujoco_25UAV.avi", cv2.VideoWriter_fourcc(*'MPEG'), 1/T_s, (view_width, view_height))
