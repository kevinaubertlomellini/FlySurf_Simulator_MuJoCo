...
# CONTROL PARAMETERS
Q_vector = [20, 20, 20, 5] # [x and y, z, velocity in x and y, velocity in z]
...
mpc = init_MPC_model2(x, str_stif,shear_stif,flex_stif,damp_point,damp_quad,l0,n_points, n_points2, n_actuators, x_actuators, mass_points, mass_quads,Q_vector, R_vector, delta, u_limits, g)
