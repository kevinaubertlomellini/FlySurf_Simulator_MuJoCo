...
u_limits = np.array([[-0.5, 0.5], [-0.5, 0.5], [-5.0, 10.0]]) # Actuator limits
...
# CONTROL PARAMETERS
Q_vector = [25, 8000000, 0, 0, 0, 0, 0.1, 0.1] # [x and y, z, v_x and v_y, v_z, x_UAV and y_UAV, z_UAV , v_x_quad and v_y_quad, v_z_quad]
R_vector = [200, 4] # [force in x and y, force in z]
