...
damp_point = 0.1 # Damping coefficient on each point
...
mpc  = init_MPC_general(str_stif,shear_stif,flex_stif,damp_point,damp_quad,l0,n_points, n_points2, n_actuators, x_actuators, mass_total/(n_points*n_points2), mass_quads,Q_vector, R_vector, delta, u_limits, g, Rs_d_save, shape_sampled_save , xd_0_save ,N_horizon)
mpc.setup()
mpc.x0 = x
...
plot_forces3(t_save[0:step-1], u_save[:,0:step-1])
