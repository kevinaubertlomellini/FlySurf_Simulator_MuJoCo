...
alpha_H = 20*np.array([45,45,120])
alpha_G = 0
alpha_Rs = 1.05*np.array([900,900,1000])
Q_0 = 120000 * np.eye(6)
Q_0[0:2, 0:2] = 75000 * np.eye(2)
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    output = cv2.VideoWriter("SMPC_Mujoco_25UAV_Space_V2.avi", cv2.VideoWriter_fourcc(*'MPEG'), 1 / T_s, (view_width, view_height))
