...
R_vector = np.array([100000, 16000]) # [force in x and y, force in z]
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    output = cv2.VideoWriter("LQR_Mujoco_9UAV.avi", cv2.VideoWriter_fourcc(*'MPEG'), 1 / T_s, (view_width, view_height))
